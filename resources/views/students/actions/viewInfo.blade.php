...
<nav class ="nav nav-tabs justify-content-center grey" style="margin-top: -10px">
  <li class="nav-item">
  <a id="datos" href="{{route('viewInfo', $date->idAlumno)}}" class="nav-link active bg-blue">Datos</a>
  </li>
  <li class="nav-item">
...
<form class="text-center p-5" action="{{route('updateInfo', $date->idAlumno)}}" method="post">
  @csrf
  @method('put')
    ...
    <div class="form-row"><!--Columna edad-->
        ...
        <div class="col-md-2 col-12">
          <div class="md-form">
            <input type="text" id="edad" class="form-control" name="edad" onkeypress="return soloNumeros(event)" maxlength="2" value="{{$date->edad}}" >
            <label for="">Edad</label>
          </div>
        </div>
        <div class="col-md-2 col-12">
        <div class="md-form">
          <input type="date" id="fecha" class="form-control" name="fecha" maxlength="10" value="{{$date->fechaNacimiento}}">
    ...
    <div class="form-row"><!--Columna Domicilio-->
      ...
      <div class="col-md-2 col-12">
        <div class="md-form">
          <input type="text" id="number" class="form-control" name="numero" value="{{$date->numCalle}}" >
    ...
    <div class="form-row"><!--Columna colonia-->
      ...
      <div class="col-md-5 col-12">
        <div class="md-form">
          <input type="text" id="colonia" class="form-control" name="colonia" value="{{$date->colonia}}">
    ...
    <div class="form-row"><!--Columna telefono-->
      ...
      <div class="col-md-4 col-12">
        <div class="md-form">
          <input type="tel" id="telfij" class="form-control" name="telFijo" onkeypress="return soloNumeros(event)" value="{{$date->telFijo}}" >
      ...
      <div class="col-md-4 col-12">
        <div class="md-form">
          ...
          <input type="tel" id="telcel" class="form-control" name="telCelular" onkeypress="return soloNumeros(event)" value="{{$date->telCelular}}" >
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="sexo" class="form-control" name="sexo" value="{{$date->sexo}}"  disabled>
        <label for="">Sexo</label>
      </div>
    </div>
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="email" id="email" class="form-control" name="correo" value="{{$date->correoAlumno}}">
    ...
    <div class="col-md-4">
      <div class="md-form">
        ...
        <input type="email" id="correoInstitucional" class="form-control" value="{{$date->correoInstitucional}}" disabled>
        <input type="email" id="correoInstitucional" name="correoInstitucional" class="form-control" value="{{$date->correoInstitucional}}" hidden>
        @else
        <input type="email" id="correoInstitucional" class="form-control" name="correoInstitucional" value="{{$date->correoInstitucional}}">
        @endif
  ...
  <div class="form-row"><!--Columna dato escolar-->
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="esceg" class="form-control" name="escEgreso" value="{{$date->escEgreso}}" >
        <label for="">Escuela de egreso</label>
      </div>
    </div>
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="generacion" class="form-control" name="generacion" value="{{$date->generacion}}">
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="promEgreso" class="form-control" name="promEgreso" value="{{$date->promedioEgreso}}">
      ...
      <div class="col-md-6">
        <select class="browser-default custom-select text-center" name="tipoBeca" id="beca">
          ...
          @foreach ($type_beca as $tBeca)
            <option style="text-align: center" value="{{$tBeca->idTipoBeca}}">{{$tBeca->nombreTipoBeca}}</option>    
          @endforeach
        </select>
      </div>
      <div class="col-md-3"></div>
  ...
  <div class="form-row" id="porc">
    ...
    <div class="form-row" id="locali">
        ...
        <div class="col-md-6">
            <div class="md-form">
                <input type="text" class="form-control" id="locali" name="localidad" placeholder="Localidad" value="{{$date->localidad}}">
            </div>
        </div>
        <div class="col-md-3"></div>
    </div>
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        ...
        <select class="browser-default custom-select" name="perioInicio">
          <option value="{{$date->idPeriodo}}" disabled>{{$date->nombrePeriodo}} {{$date->anoPeriodo}}</option>
          @foreach ($periodos as $periodo)
              <option value="{{$periodo->idPeriodo}}">{{$periodo->nombrePeriodo}} {{$date->anoPeriodo}}</option>
          @endforeach
        </select>
      </div>
    </div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4">
      <div class="md-form">
        <input type="text" id="nombtutor" class="form-control" name="nombtutor" value="{{$date->nombreTutor}}" >
        <label>Nombre</label>
      </div>
    </div>
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="parentesco" class="form-control" name="parentesco" value="{{$date->parentescoTutor}}">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="directutor" class="form-control" name="directutor" value="{{$date->domicilioTutor}}" >
        <label>Dirección</label>
      </div>
    </div>
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="tel" id="teltutor" class="form-control" name="teltutor" onkeypress="return soloNumeros(event)" value="{{$date->telTutor}}" >
