                    ...
                    @foreach ($inscritosCurso as $data)
                        ...
                        <tr>
                            <form action="{{ route('actualizarCalificacion', $data->idAlumnoCursoNota) }}" method="post">
                                ...
                                <td>
                                    <input type="checkbox" value="" name="AS1" size="1" style="border: none">
                                </td>
                                <td>
                                ...
                                <td></td>
                                <td></td>
                                <td class="text-center"><input type="submit" name="segundo" class="btn btn-primary"
                                        value="Calificar"></td>
