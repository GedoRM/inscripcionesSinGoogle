...
<div class="container">
    <div class="col-md-12 col-sm-8" >
        ...
        <tbody>
            @foreach ($detailCourse as $data)
            <form action="{{route('updateCalif', $data->idUserCourse)}}" method="post">
                @method('PUT')
                @csrf
            <tr> 
                <td>{{$data->idUserCourse}}</td>
                <td>{{$data->nombre}}</td>
                
                <td><input min="5" max="10" id="nota1" type="text" maxlength="2" name="nota1" value="{{$data->nota1}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="falta1" type="text" maxlength="1" name="falta1" value="{{$data->falta1}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="nota2" type="text" maxlength="2" name="nota2" value="{{$data->nota2}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="falta2" type="text" maxlength="1" name="falta2" value="{{$data->falta2}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="nota3" type="text" maxlength="2" name="nota3" value="{{$data->nota3}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="falta3" type="text" maxlength="1" name="falta3" value="{{$data->falta3}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="notaFinal" type="text" maxlength="2" name="final" value="{{$data->notaFinal}}" size="3" class="text-center m-auto d-block" onkeypress="return soloNumeros(event)" style="border: none"></td>
                <td><input id="textoFinal"  type="text" style="width: 200px" name="letras" value="{{$data->letra}}" size="3" class="text-center m-auto d-block" style="border: none"></td>
                <td class="text-center"><input type="submit" name="btn{{$data->idUserCourse}}" value="Calificar"></td>
            </tr>
            </form>
            @endforeach
        </tbody>
