...
@section('contenido')
    @foreach ($student as $date)
        <nav class="nav nav-tabs justify-content-center grey" style="margin-top: -10px">
            <li class="nav-item">
                <a style="color:black" id="datos" href="{{ route('verPerfil', $date->idAlumno) }}" class="nav-link ">Datos</a>
            </li>
            <li class="nav-item">
            ...
            @can('Administrador')
                <li class="nav-item">
                    <a href="{{ route('recepcionDocumentos', $date->idAlumno) }}" id="doc"
                        class="nav-link active bg-blue">Recepción Documentos</a>
                </li>
            @endcan
        </nav>
        <br><br>
        <div class="container">
            <form class="ml-5" action="{{route('recepcionDocumentosPDF',$date->idAlumno)}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-4 col-12">
                        ...
                        <div class="md-form">
                            <input name="nombreAlumno"
                                value="{{ $date->apePaterno }} {{ $date->apeMaterno }} {{ $date->nombre }}" hidden>
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-4 col-12">
                        <div class="md-form">
                            <input class="form-control" id="programa" type="text" value="{{ $date->nombrePrograma }}"
                                disabled>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="md-form">
                            <input class="form-control" id="cuatri" type="number" name="cuatrimestre" min="1" max="9"
                                placeholder="Cuatrimestre" required>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="md-form">
                            <input class="form-control" id="modalidad" type="text" value="{{ $date->nombreModalidad }}"
                                disabled>
                ...
                <div class="form-row">
                    <div class="col-md-5 col-12">
                        ...
                        <br>
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="certBachi" name="certificadoOriginal"
                                value="1">
                        ...
                        <br>
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="consEstud" name="constanciaOriginal"
                                value="1">
                        ...
                        <br>
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="ineAlum" name="ineAlumnoOriginal"
                                value="1">
                        ...
                        <br>
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="ine_tu" name="ineTutorOriginal"
                                value="1">
                        ...
                        <br>
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="comprobante_d"
                                name="comprobanteOriginal" value="1">
                ...
                <div class="row">
                    <div class="col-md-6 text-center">
                        <input class="form-control text-center" type="text" style="border: none;" name="recibe"
                    ...
                    <div class="col-md-6 text-center">
                        <input class="form-control text-center" type="text" name="entrega"
                            value="{{ $date->apePaterno }} {{ $date->apeMaterno }} {{ $date->nombre }}"
                            style="border: none; " disabled>
                        <input name="entrega" value="{{ $date->apePaterno }} {{ $date->apeMaterno }} {{ $date->nombre }}"
                            hidden>
                        <hr>
