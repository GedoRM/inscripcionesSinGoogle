    ...
    <tbody class="">
        ...
        <tr>
            ...
            <th class="text-center">
                <div class="row">
                    <a href="{{route('perfilAspirante', $students->idAlumno)}}"><button class="ml-3 mr-3 btn btn-warning btn-sm" title="Editar"><i class="fas fa-pen" style="color:white"></i></button></a>
