...
<li class="nav-item">
<a id="datos" href="{{route('academy.infoStudent', $date->idAlumno)}}" class="nav-link active bg-blue">Datos</a>
</li>
<li class="nav-item">
<a style="color:black" href="{{route('academy.viewDocuments', $date->idAlumno)}}" class="nav-link">Documentos</a>
</li>
</nav>
<div class="text-center p-5">
  ...
  <div class="form-row"><!--Columna Datos de Alumnos-->
    ...
    <div class="col-12 col-md-2">
      <div class="md-form">
        <input type="text" id="ap" class="form-control" name="apePaterno" value="{{$date->apePaterno}}" disabled>
        <label for="">Apellido paterno</label>  
      </div>
    </div>
    <div class="col-12 col-md-2">
      <div class="md-form">
        <input type="text" id="am" class="form-control" name="apeMaterno" value="{{$date->apeMaterno}}" disabled>
        <label for="">Apellido materno</label>
      </div>
    </div>
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input type="text" id="nomb" class="form-control" name="nombre" value="{{$date->nombre}}" disabled>
  ...
  <div class="form-row"><!--Columna edad-->
      ...
      <div class="col-md-2 col-12">
        <div class="md-form">
          <input disabled type="text" id="edad" class="form-control" name="edad" onkeypress="return soloNumeros(event)" maxlength="2" value="{{$date->edad}}" >
          <label for="">Edad</label>
        </div>
      </div>
      <div class="col-md-2 col-12">
      <div class="md-form">
        <input disabled type="date" id="fecha" class="form-control" name="fecha" maxlength="10" value="{{$date->fechaNacimiento}}">
  ...
  <div class="form-row"><!--Columna Domicilio-->
    ...
    <div class="col-md-6 col-12">
      <div class="md-form">
        <input disabled type="text" id="calle" class="form-control" name="calle" value="{{$date->calle}}" >
        <label for="">Calle</label>
      </div>
    </div>
    <div class="col-md-2 col-12">
      <div class="md-form">
        <input disabled type="text" id="number" class="form-control" name="numero" value="{{$date->numCalle}}" >
  ...
  <div class="form-row"><!--Columna colonia-->
    ...
    <div class="col-md-5 col-12">
      <div class="md-form">
        <input disabled type="text" id="colonia" class="form-control" name="colonia" value="{{$date->colonia}}">
  ...
  <div class="form-row"><!--Columna telefono-->
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        <input disabled type="tel" id="telfij" class="form-control" name="telFijo" onkeypress="return soloNumeros(event)" value="{{$date->telFijo}}" >
    ...
    <div class="col-md-4 col-12">
      <div class="md-form">
        ...
        <input disabled type="tel" id="telcel" class="form-control" name="telCelular" onkeypress="return soloNumeros(event)" value="{{$date->telCelular}}" >
  ...
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input disabled type="text" id="sexo" class="form-control" name="sexo" value="{{$date->sexo}}"  disabled>
      <label for="">Sexo</label>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input disabled type="email" id="email" class="form-control" name="correo" value="{{$date->correoAlumno}}">
  ...
  <div class="col-md-4">
    <div class="md-form">
      ...
      <input disabled type="email" id="correoInstitucional" class="form-control" value="{{$date->correoInstitucional}}" disabled>
...
<div class="form-row"><!--Columna dato escolar-->
  ...
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input disabled type="text" id="esceg" class="form-control" name="escEgreso" value="{{$date->escEgreso}}" >
      <label for="">Escuela de egreso</label>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input disabled type="text" id="generacion" class="form-control" name="generacion" value="{{$date->generacion}}">
  ...
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input disabled type="text" id="promEgreso" class="form-control" name="promEgreso" value="{{$date->promedioEgreso}}">
...
<div class="form-row" id="porc">
  ...
  <div class="form-row" id="locali">
      ...
      <div class="col-md-6">
          <div class="md-form">
              <input disabled type="text" class="form-control" id="locali" name="localidad" placeholder="Localidad" value="{{$date->localidad}}">
          </div>
      </div>
      <div class="col-md-3"></div>
  </div>
  ...
  <div class="col-md-4 col-12">
    <div class="md-form">
      ...
      <select class="browser-default custom-select" name="perioInicio" disabled>
        <option value="{{$date->idPeriodo}}">{{$date->nombrePeriodo}} {{$date->anoPeriodo}}</option>
      </select>
    </div>
  </div>
  <div class="col-md-4 col-12">
...
<div class="form-row">
  ...
  <div class="col-md-4">
    <div class="md-form">
      <input type="text" id="nombtutor" class="form-control" name="nombtutor" value="{{$date->nombreTutor}}" disabled>
      <label>Nombre</label>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input type="text" id="parentesco" class="form-control" name="parentesco" value="{{$date->parentescoTutor}}" disabled>
...
<div class="form-row">
  ...
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input type="text" id="directutor" class="form-control" name="directutor" value="{{$date->domicilioTutor}}" disabled >
      <label>Dirección</label>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="md-form">
      <input disabled type="tel" id="teltutor" class="form-control" name="teltutor" onkeypress="return soloNumeros(event)" value="{{$date->telTutor}}" >
